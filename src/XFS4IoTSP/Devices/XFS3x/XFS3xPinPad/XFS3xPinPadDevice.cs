...
namespace XFS3xPinPad
{
    ...
    /// </summary>
    public partial class XFS3xPinPadDevice : PINDevice, IPinPadDevice, IKeyboardDevice, ICryptoDevice, IKeyManagementDevice, ICommonDevice
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            Logger.Debug($"Call [{nameof(StoreKeys)}]");
        ...
        {
            Logger.Debug($"Call [{nameof(GetKeys)}]");
